 ...
 */
package fun.yuner.raft.remoting.netty;

import fun.yuner.raft.remoting.ChannelEventListener;
import fun.yuner.raft.remoting.InvokeCallback;
import fun.yuner.raft.remoting.RPCHook;
import fun.yuner.raft.remoting.common.Pair;
import fun.yuner.raft.remoting.common.RemotingHelper;
import fun.yuner.raft.remoting.common.SemaphoreReleaseOnlyOnce;
import fun.yuner.raft.remoting.common.ServiceThread;
...
import fun.yuner.raft.remoting.protocol.RemotingSysResponseCode;
...
public abstract class NettyRemotingAbstract {
     ...
     */
    private static final InternalLogger log = InternalLoggerFactory.getInstance(RemotingHelper.ROCKETMQ_REMOTING);
